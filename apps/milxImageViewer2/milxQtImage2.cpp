...
//milxQtImage2
milxQtImage2::milxQtImage(QWidget *theParent, bool contextSystem) : milxQtRenderWindow(theParent, contextSystem)
{
...
void milxQtImage2::setData(QPointer<milxQtImage> newImg, const bool forceDeepCopy)
{
...
void milxQtImage2::setData(charImageType::Pointer newImg, const bool flipY)
{
...
void milxQtImage2::setData(rgbImageType::Pointer newImg, const bool flipY)
{
...
void milxQtImage2::setData(floatImageType::Pointer newImg, const bool flipY)
{
...
void milxQtImage2::setData(vectorImageType::Pointer newImg, const bool flipY, const bool deepCopy)
{
    if(deepCopy)
...
void milxQtImage2::setData(vnl_matrix<double> &newData)
{
...
void milxQtImage2::setData(const unsigned slice, vnl_matrix<double> &newData)
{
    setData(newData);
}

void milxQtImage2::setData(vtkSmartPointer<vtkImageData> newImg)
{
...
void milxQtImage2::setDisplayData(QPointer<milxQtImage> newImg)
{
    if(newImg->is8BitImage())
...
void milxQtImage2::setDisplayData(charImageType::Pointer newImg, const bool flipY)
{
    imageChar = newImg;
...
void milxQtImage2::setDisplayData(rgbImageType::Pointer newImg, const bool flipY)
{
    imageRGB = newImg;
...
void milxQtImage2::setDisplayData(floatImageType::Pointer newImg, const bool flipY)
{
    imageFloat = newImg;
...
void milxQtImage2::setDisplayData(vectorImageType::Pointer newImg, const bool flipY)
{
...
void milxQtImage2::SetTransform(vtkSmartPointer<vtkTransform> newTransform)
{
    if(loaded)
    {
        emit working(-1);
...
void milxQtImage2::generateVoxelisedSurface(vtkSmartPointer<vtkPolyData> surfaceToVoxelise, double *bounds, double *spacing)
{
    bool ok1, ok2, ok3;
...
//VTK Filters
vtkSmartPointer<vtkImageData> milxQtImage2::butterWorthHighPass(vtkSmartPointer<vtkImageData> img)
{
...
void milxQtImage2::trackView(milxQtImage2 *windowToTrack, ViewType viewTo)
{
...
void milxQtImage2::userEvent(QMouseEvent *event)
{
    emit milxQtRenderWindow::modified(GetImageActor());
}

void milxQtImage2::userEvent(QKeyEvent *event)
{
    emit milxQtRenderWindow::modified(GetImageActor());
}

void milxQtImage2::userEvent(QWheelEvent *event)
{
    emit milxQtRenderWindow::modified(GetImageActor());
}

void milxQtImage2::updateCoords(vtkObject *obj)
{
    ///Get interactor
...
void milxQtImage2::updateSlice(vtkObject *obj)
{
    vtkRenderWindowInteractor* iren = vtkRenderWindowInteractor::SafeDownCast(obj);
...
void milxQtImage2::updateTrackedView(vtkObject *obj)
{
    vtkRenderWindowInteractor* iren = vtkRenderWindowInteractor::SafeDownCast(obj);
...
void milxQtImage2::updateData(const bool orient)
{
    if(!usingVTKImage)
    {
...
void milxQtImage2::autoLevel(float percentile)
{
...
void milxQtImage2::setLevel(int level)
{
...
double milxQtImage2::GetIntensityWindow()
{
    return viewer->GetWindowLevel()->GetWindow();
}

double milxQtImage2::GetIntensityLevel()
{
    return viewer->GetWindowLevel()->GetLevel();
}

void milxQtImage2::SetIntensityWindow(double window)
{
    viewer->GetWindowLevel()->SetWindow(window);
}

void milxQtImage2::SetIntensityLevel(double level)
{
    viewer->GetWindowLevel()->SetLevel(level);
}

#if (ITK_REVIEW || ITK_VERSION_MAJOR > 3)
void milxQtImage2::overlay(QString filename)
{
    ...
    QPointer<milxQtImage2> labelledImage = new milxQtImage2;
...
void milxQtImage2::overlayContour(QString filename)
{
...
void milxQtImage2::computeContour()
{
    if(usingVTKImage)
    {
...
void milxQtImage2::blend(QString filename, float opacity)
{
    if(usingVTKImage)
    {
...
//    emit working(-1);
    ...
    QPointer<milxQtImage2> imageToMatch = new milxQtImage2;
    QPointer<milxQtFile> reader = new milxQtFile;
...
void milxQtImage2::blend(milxQtImage2 *imageToMatch, float opacity)
{
    bool ok1 = true;
    if(opacity < 0.0)
    {
...
void milxQtImage2::volumeRendering()
{
...
void milxQtImage2::imageInformation()
{
...
void milxQtImage2::histogramEqualisation()
{
    if(usingVTKImage)
    {
...
void milxQtImage2::gradientMagnitude()
{
    if(usingVTKImage)
    {
...
void milxQtImage2::invertIntensity()
{
    if(usingVTKImage)
    {
...
void milxQtImage2::matchInfo(milxQtImage2 *imageToMatch)
{
...
void milxQtImage2::matchInfo(QString filename)
{
    if(usingVTKImage)
    {
...
void milxQtImage2::matchHistogram(milxQtImage2 *imageToMatch)
{
...
void milxQtImage2::matchHistogram(QString filename)
{
    if(usingVTKImage)
    {
...
void milxQtImage2::resample(QString filename)
{
    if(usingVTKImage)
    {
...
void milxQtImage2::mask(QString filename)
{
    if(usingVTKImage)
    {
...
void milxQtImage2::subsample(size_t xSampleFactor, size_t ySampleFactor, size_t zSampleFactor)
{
    if(usingVTKImage)
    {
        printError("Resampling from VTK image not support yet.");
...
void milxQtImage2::crop(QString filename)
{
    if(usingVTKImage)
    {
        printError("Masking from VTK image not support yet.");
...
void milxQtImage2::resampleLabel(QString filename)
{
    if(usingVTKImage)
    {
        printError("Resampling from VTK image not support yet.");
...
void milxQtImage2::transform(QString filename, QString refImgFilename, bool inverse)
{
    if(usingVTKImage)
    {
...
void milxQtImage2::checkerBoard(milxQtImage2 *img, int numberOfSquares)
{
    if(usingVTKImage)
    {
        printError("Checker Board from VTK image not support yet.");
...
void milxQtImage2::checkerBoard(QString filename, int numberOfSquares)
{
    if(usingVTKImage)
    {
        printError("Checker Board from VTK image not support yet.");
...
void milxQtImage2::distanceMap(bool signedDistance, bool inside)
{
    if(usingVTKImage)
    {
...
void milxQtImage2::thresholdAbove(float value, float level)
{
    if(usingVTKImage)
    {
...
void milxQtImage2::thresholdBelow(float value, float level)
{
    if(usingVTKImage)
    {
...
void milxQtImage2::threshold(float value, float blevel, float alevel)
{
    if(usingVTKImage)
    {
...
void milxQtImage2::otsu(int bins)
{
    if(usingVTKImage)
    {
...
void milxQtImage2::otsuMultiple(int bins, int labels)
{
    if(usingVTKImage)
    {
...
void milxQtImage2::binaryThreshold(float value, float blevel, float alevel)
{
    if(usingVTKImage)
    {
...
void milxQtImage2::flip(bool xAxis, bool yAxis, bool zAxis, bool aboutOrigin)
{
    if(usingVTKImage)
    {
...
void milxQtImage2::surface(const float value)
{
    updateData(orientAct->isChecked());
...
void milxQtImage2::component(int index)
{
    if(!vectorised)
        return;
...
void milxQtImage2::vectorField(int subsampleFactor, float scaling)
{
    if(!vectorised)
        return;
...
void milxQtImage2::anisotropicDiffusion()
{
    if(usingVTKImage)
    {
...
void milxQtImage2::gaussianSmooth()
{
    if(usingVTKImage)
    {
...
void milxQtImage2::zeros(const unsigned long xSize, const unsigned long ySize, const unsigned long zSize, milxQtImage2 *refImage)
{
    if(usingVTKImage)
    {
...
void milxQtImage2::resize(double outputSpacing)
{
...
void milxQtImage2::resize(const unsigned long xSize, const unsigned long ySize, const unsigned long zSize, milxQtImage2 *refImage)
{
    if(usingVTKImage)
    {
        printError("Adding of VTK image not support yet.");
...
void milxQtImage2::add(milxQtImage2 *img)
{
    if(usingVTKImage)
    {
        printError("Adding of VTK image not support yet.");
...
void milxQtImage2::add(QString filename)
{
    if(usingVTKImage)
    {
    ...
    QPointer<milxQtImage2> imageToSubtract = new milxQtImage2;
    QPointer<milxQtFile> reader = new milxQtFile;
...
void milxQtImage2::subtract(milxQtImage *img)
{
    if(usingVTKImage)
    {
